...
### В проекте реализовано
  1. Первоначалное развертывание проекта odoo (Odoo (бывшая Tiny ERP, OpenERP) — ERP- и CRM-система, разрабатываемая бельгийской компанией Odoo S. A. Распространяется по лицензии LGPL)
  2. База данных Postgresql. База имее реплику в виде отдельного сервера. Репликация async.
  ...
  8. На фронте установлен `haproxy` - устанавливает защищенное соединение SSL и редирект на nginx
  9. На фронте установлен nginx, который проксирует соединения на odoo.
# Схема проекта
